<?php 
session_start();
$connect = mysqli_connect("localhost", "root", "server", "loscalmos");
	...
	if($_GET["action"] == "delete")
	{
		foreach($_SESSION["shopping_cart"] as $keys => $values)
		{
			if($values["item_id"] == $_GET["id"])
			{
				...
				echo '<script>window.location="index111.php"</script>';
			}
		}
	}
}
	...
	<body>
		...
		<div class="container">
			...
			<?php
				...
				?>
			<div class="col-md-4">
				<form method="post" action="index111.php?action=add&id=<?php echo $row["id"]; ?>">
			...
			<div class="table-responsive">
				<table class="table table-bordered">
					...
					<tr>
						...
						<td><a href="index111.php?action=delete&id=<?php echo $values["item_id"]; ?>"><span class="text-danger">Remove</span></a></td>
					</tr>
					<?php
